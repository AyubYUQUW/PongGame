...
function update() {
    ...
    if (detectCollision(ball,player1)) {
        if (ball.x <= player1.x + player1.width){
            // left side of the ball touches the right side of player1
            ball.velocityX *= -1; //flips x direction
        }
    }
    ...
    for (let i=10; i < board.height; i += 25) {
        ...
        context.fillRect(board.width/2 - 20, i, 5,5);
    }
